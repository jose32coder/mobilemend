        ...
        <div className="w-full min-h-screen bg-slate-100 flex">
            ...
            <div className="w-full md:w-2/4 bg-white px-12 sm:px-20 md:px-10 lg:px-20 xl:px-25 flex flex-col justify-center">
                <div className="flex flex-col items-center justify-center gap-4 mb-5">
                    ...
                    <p className='text-gray-500 text-sm sm:text-md'>Por favor, registrate a continuación:</p>
                ...
                <div className="mt-5 flex flex-col sm:flex-row sm:gap-2 md:flex-row md:gap-2 lg:flex-row lg:gap-2 xl:flex-row xl:space-4">
                    <div className="flex-1">
                        <label htmlFor="firstName" className="block text-gray-950 text-sm font-bold my-1">Nombre</label>
                        <input
                            type="text"
                            id="firstName"
                            name="firstName"
                    ...
                    <div className="flex-1">
                        <label htmlFor="lastName" className="block text-gray-950 text-sm font-bold my-1">Apellido</label>
                        <input
                            type="text"
                            id="lastName"
                            name="lastName"
                ...
                <div className="mt-2 sm:mt-5 flex flex-col sm:flex-row sm:gap-2 md:flex-row md:gap-2 lg:flex-row lg:gap-2 xl:flex-row xl:space-4">
                    <div className="flex-1">
                        <label htmlFor="email" className="block text-gray-950 text-sm font-bold my-1">Correo</label>
                        <input
                            type="text"
                            id="email"
                            name="email"
                    ...
                    <div className="flex-1">
                        <label htmlFor="telephone" className="block text-gray-950 text-sm font-bold my-1">Teléfono</label>
                        <input
                            type="text"
                            id="telephone"
                            name="telephone"
                ...
                <div className="mt-2 sm:mb-5 mb-6 flex flex-col gap">
                    <label htmlFor="confirmPassword" className='block text-gray-950 text-sm font-bold mb-2'>Confirmar contraseña</label>
                    <div className="relative">
                        <input
